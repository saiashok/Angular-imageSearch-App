...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_image_service__ = __webpack_require__("../../../../../src/app/shared/image.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__image_list_image_list_component__["a" /* ImageListComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__shared_image_service__["a" /* ImageService */]],
...
module.exports = "\n<input  class=\"form-control\" type=\"text\" [(ngModel)]= \"searchQuery\" placeholder=\"Search for Images\">\n<button class=\"btn btn-primary\" (click)=\"searchImages(searchQuery)\" type=\"button\">Find Images</button>\n\n<p *ngIf=\"searching\"> Fetching data........</p>\n<div *ngFor=\"let image of images\">\n  <img src=\"{{image.webformatURL}}\">\n  <p>Tags: {{image.tag}}</p>\n  <p>User: {{image.user}}</p>\n  <p>Downloads: {{image.downloads}}</p>\n  <p>favorites: {{image.favorites}}</p>\n</div>\n\n"
...
var ImageListComponent = (function () {
    function ImageListComponent(imageSerivce) {
    ...
    ImageListComponent.prototype.searchImages = function (query) {
        var _this = this;
        return this.imageSerivce.getImage(query).subscribe(function (data) { return _this.handleSuccess(data); }, function (error) { return _this.handleError(error); }, function () { return console.log("Request completed..!"); });
    };
...
var ImageService = (function () {
    ...
    ImageService.prototype.getImage = function (query) {
        return this._http.get(this.URL + query).map(function (res) { return res.json(); });
    };
